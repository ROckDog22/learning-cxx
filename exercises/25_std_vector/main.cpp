...
int main(int argc, char **argv) {
    ...
    }
    {
        ...
        }
        {
            ...
            ASSERT(vec[48] == 0, "Fill in the correct value.");
            ASSERT(vec[49] == 0, "Fill in the correct value.");
            ASSERT(vec[50] == 0, "Fill in the correct value.");
            ASSERT(vec[51] == 0, "Fill in the correct value.");
        }
    }
